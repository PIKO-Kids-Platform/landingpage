                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="single-blog res-margin">
                            <!-- Blog Thumb -->
                            <div class="blog-thumb">
                                <a href="#"><img src="{{ asset('assets/img/blog/blog-4.jpg')}}" alt=""></a>
                            </div>
                            <!-- Blog Content -->
                            <div class="blog-content p-4">
                                <!-- Meta Info -->
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="single-blog res-margin">
                            <!-- Blog Thumb -->
                            <div class="blog-thumb">
                                <a href="#"><img src="{{ asset('assets/img/blog/blog-5.jpg')}}" alt=""></a>
                            </div>
                            <!-- Blog Content -->
                            <div class="blog-content p-4">
                                <!-- Meta Info -->
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="single-blog res-margin">
                            <!-- Blog Thumb -->
                            <div class="blog-thumb">
                                <a href="#"><img src="{{ asset('assets/img/blog/blog-6.jpg')}}" alt=""></a>
                            </div>
                            <!-- Blog Content -->
                            <div class="blog-content p-4">
                                <!-- Meta Info -->
